...
" Insert // at first of every line in the file, (x) remove
nnoremap <leader>a  :%s!^!//!
nnoremap <leader>ax :%s!^//!!
" Insert $$ at end of line in the file, (x) remove
nnoremap <leader>aa  :%s!$!$$!
nnoremap <leader>aax :%s!$$$!!

" Replace regex under visual mode
vnoremap <leader>s :s/\v(.*)/\1/gc
" Insert // at first of selected line under visual mode (x) remove
vnoremap <leader>a  :s!^!//!
vnoremap <leader>ax :s!^//!!
" Insert $$ at end of selected line under visual mode, (x) remove
vnoremap <leader>aa  :s!$!$$!
vnoremap <leader>aax :s!$$$!!
